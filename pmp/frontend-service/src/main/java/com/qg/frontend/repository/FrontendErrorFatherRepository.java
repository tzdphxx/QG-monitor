...
@Slf4j
@Repository
public abstract class FrontendErrorFatherRepository extends ErrorRepository<FrontendError> {

    @Autowired
    protected FrontendErrorMapper frontendErrorMapper;

    @Autowired
    public FrontendErrorFatherRepository(StringRedisTemplate stringRedisTemplate,
                                         ProjectClient projectClient,
                                         RestTemplateBuilder restTemplateBuilder) {
        super(stringRedisTemplate, projectClient, restTemplateBuilder);
    }
